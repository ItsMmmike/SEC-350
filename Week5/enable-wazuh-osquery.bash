...
# To Use: Download and run script as root (workaround for permission issues) --> "sudo curl -O https://raw.githubusercontent.com/ItsMmmike/SEC-350/refs/heads/main/Week5/enable-wazuh-osquery.bash && sudo bash ./enable-wazuh-osquery.bash"
